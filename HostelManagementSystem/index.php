...
<div class="Nav" id="Nav1">
  <div class="NavbarContainer">
    <img src="images\fiem1.jpg" alt="FIEM" class="NavLogo" onclick="rtohome()">
...
<div class="HeroContainer">
  ...
  <source src="videos\FIEM_Video.mp4" type="video/mp4">
</video>x
  </div>
<div class="HeroContent">
  <h1 class="HeroH1">Hostel Management System</h1>
  <p class="HeroP">Future Institute Of Engineering & Management</p>
...
<div class="BtnWrap">
<button type="button" name="button" class="NavBtnLink" onclick="coming()">Get Started</button>
</div>
</div>
</div>
...
<div class="FooterWrap">
  <div class="FooterLinksContainer">
    <div class="FooterLinksWrapper">
        <div class="FooterLinkItems">
            ...
            <a href="user_feedback.php" class="FooterLink">Feedback</a>
  ...
  <div class="SocialMedia">
    <div class="SocialMediaWrap">
      ...
      <p class="WebsiteRights">FIEM © 2023</p>
      <div class="SocialIcons">
        <a href="https://www.facebook.com" class="SocialIconLink"><i class="fa fa-facebook-square" aria-hidden="true"></i></a>
        <a href="https://twitter.com" class="SocialIconLink"><i class="fa fa-twitter" aria-hidden="true"></i></a>
