      ...
      <form action="applyleave.php" method="post">
        <div class="user-details">
          <div class="input-box">
            ...
            <input type="text" placeholder="Enter your name" pattern="[a-z A-Z]*" value="<?php echo $name; ?>" required
              disabled>
          </div>
          <div class="input-box">
            <span class="details">Reg No</span>
            <input type="text" placeholder="Enter your regno" pattern="[0-9]{2}[A-Z]{3}[0-9]{4}"
              value="<?php echo $regno; ?>" disabled required>
          </div>
          <div class="input-box">
