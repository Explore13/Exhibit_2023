...
function compReq(){
   window.location.href ="complainApplication.php";
}
</script>
  </head>
  <body>
...
<div class="wrapper">
   ...
   <div class="content">
      ...
      <div class="card" onclick="requests()">
            ...
            <p class="title">Leave <br> Requests</p>
      ...
      <!-- card -->
            <div class="card" onclick="compReq()">

         <div class="icon"><i class="material-icons md-36">forum</i></div>
         <p class="title">Complains</p>
         <p class="text">Solve or reject complains.</p>
