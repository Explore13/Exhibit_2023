...
(min-device-width: 768px) and (max-device-width: 1024px)  {
  ...
  <body>
    ...
    <?php
      ...
      $sql="SELECT * FROM complainapplications;";
      ...
      function approve() {
        ...
        $regno1=$_POST['id'];
        $sql1="UPDATE `complainapplications` SET `status`='solved' where regno='$regno1'";
      ...
      function reject() {
        ...
        $regno1=$_POST['id'];
        echo $regno1;
        $sql1="UPDATE `complainapplications` SET `status`='rejected' where regno='$regno1'";
        $query1=mysqli_query($conn,$sql1);
        if($query1){
          echo 'successful';
   ...
   ?>
    <form class="" action="complainApplication.php" method="post">
  ...
  <tbody>
    ...
    <td><?php echo $rows['complain']; ?></td>
        ...
        if($rows['status']=="Pending"){
         ?>
        <td>
          <input type="submit" name="approve" class="approvebtn" value="Solve">
